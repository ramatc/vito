  ...
  return (
    ...
    >
      ...
      <div className="min-w-0 flex-1">
        ...
        <p
          className={cn(
            'truncate text-xs text-slate-500 transition-opacity duration-300 dark:text-muted',
        ...
        <AnimatePresence>
          {visibleGain !== undefined && (
            <motion.span
              ...
              className="pointer-events-none absolute -top-1 right-0 whitespace-nowrap text-xs font-semibold text-emerald-600 dark:text-brand"
            >
