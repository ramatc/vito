...
export const EN = {
  ...
  'habits.reports.title': 'Weekly report',
  'habits.reports.description': 'All your habits, one week at a time.',
  'habits.reports.week.previous': 'Previous week',
  'habits.reports.week.next': 'Next week',
  'habits.reports.empty.description': 'Add a habit to see it show up here.',
  'habits.reports.empty.action': 'Go to habits',
  'habits.reports.cell.completed': '{name} completed',
  'habits.reports.cell.missed': '{name} missed',
  'habits.reports.cell.rest': '{name} not scheduled',
  'habits.reports.cell.pending': "{name} due today, not done yet",
