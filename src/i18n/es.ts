...
export const ES: Dictionary = {
  ...
  'habits.reports.entry': 'Reporte semanal',
  'habits.reports.back': 'Volver a hábitos',
  'habits.reports.title': 'Reporte semanal',
  'habits.reports.description': 'Todos tus hábitos, semana por semana.',
  'habits.reports.week.previous': 'Semana anterior',
  'habits.reports.week.next': 'Semana siguiente',
  'habits.reports.empty.description': 'Agregá un hábito para verlo acá.',
  'habits.reports.empty.action': 'Ir a hábitos',
  'habits.reports.cell.completed': '{name} completado',
  'habits.reports.cell.missed': '{name} fallado',
  'habits.reports.cell.rest': '{name} sin agendar',
  'habits.reports.cell.pending': '{name} agendado para hoy, todavía sin hacer',
  ...
  'vito.mood.thriving.headline': 'Vito está radiante',
  'vito.mood.thriving.body': 'Hoy salió todo. Disfrutá cómo se siente.',
  'vito.mood.thriving.alt': 'radiante',
  'vito.mood.happy.headline': 'Vito está contento',
  'vito.mood.happy.body': 'Apareciste. Ese es todo el truco, repetido.',
  'vito.mood.happy.alt': 'sonriendo',
  'vito.mood.content.headline': 'Vito está tranquilo',
  'vito.mood.content.body': 'No hay nada urgente. Elegí un hábito cuando quieras.',
  'vito.mood.content.alt': 'tranquilo',
  'vito.mood.sleepy.headline': 'Vito está dormitando',
  'vito.mood.sleepy.body': 'Estuvo tranquilo. Un hábito chico alcanza para despertarlo.',
  'vito.mood.sleepy.alt': 'dormitando',
  'vito.mood.resting.headline': 'Vito está descansando',
  'vito.mood.resting.body': 'Se la tomó con calma, y está listo cuando vos quieras.',
  'vito.mood.resting.alt': 'descansando con los ojos cerrados',
  'vito.mood.allDone.headline': 'Vito está encantado',
  'vito.mood.allDone.body': 'Eso es todo lo agendado para hoy. El resto es tuyo.',
  'vito.mood.comeback.headline': 'Vito se alegra de que volviste',
  'vito.mood.comeback.body':
    'Tus próximos hábitos valen XP extra. No hay nada que recuperar.',
